...
| --------------- | ------------------------------------------------------------ | :------------: | :----------: | -------------------------------------------------------- |
| EPA             | [Safe Drinking Water Information System (SDWIS)]( https://ofmpub.epa.gov/apex/sfdw/f?p=108:1:0::NO:1) |       💧💧💧💧       |     💧💧💧      | Limited data, easy to scrape with R. <br />Can get violation data, treatment, water system detail, and purchaser-seller info from [Federal Report](https://ordspub.epa.gov/ords/sfdw_rest/r/sfdw/sdwis_fed_reports_public/6?p6_report=FAC). Overlaps with ECHO. <br />Metadata tables to scrape (https://enviro.epa.gov/envirofacts/metadata/search) (https://enviro.epa.gov/envirofacts/metadata/model) <br />*Updated quarterly*.                            |                              |
| EPA             | [Enforcement & Compliance History Online (ECHO)](https://echo.epa.gov/) |      💧💧💧      |    💧💧💧💧💧     | Good, but so much [data](https://echo.epa.gov/tools/data-downloads) it's hard to know what's what. <br />See [Drinking Water Dashboard](https://echo.epa.gov/trends/comparative-maps-dashboards/drinking-water-dashboard) for overview of SDWA regulatory activities. Extensive info on utility and contacts, large datasets, povides linkages to merge with other federal and demographic data, particularly useful to developers, programmers, academics, and analysts. <br />Download latest FRS and SDWA Drinking Water Data Downloads (https://echo.epa.gov/tools/data-downloads)     |
...
| EPA | [USEPA IRIS Information](https://www.epa.gov/iris) |     💧💧💧💧💧      |    💧     | Concentration on drinking (oral) route of exposure, not air. For Maximum Contaminant Level (MCL) info, refer to [NPDWR table](https://www.epa.gov/sdwa/drinking-water-regulations-and-contaminants). <br />See [CompTox Chemicals Dashboard](https://comptox.epa.gov/dashboard/) and [EPA Health Advisories tables](https://www.epa.gov/system/files/documents/2022-01/dwtable2018.pdf) for info on toxicology data used for setting the MCL. 
| RAIS | [Risk Assessment Information System](https://rais.ornl.gov/) |     💧💧💧💧💧      |    💧💧💧💧💧     | Immensely useful tool for occurrence and risk assessment work. Data from IRIS plus others. Use [R webchem package](https://cran.r-project.org/web/packages/webchem/index.html) to get chemical data.
...
| EPA | [EJ Screen](https://www.epa.gov/ejscreen/download-ejscreen-data) |       💧💧💧💧       |    💧💧💧     | Combining environmental and socioeconomic indicators for environmental jystice analysis. See [EJScreen Mapping Tool](https://ejscreen.epa.gov/mapper/). Download [EJScreen Technical Documentation (PDF)](https://www.epa.gov/system/files/documents/2024-07/ejscreen-tech-doc-version-2-3.pdf).
...
| EPA | [Clean Water SRF Location Data](https://sdwis.epa.gov/ords/sfdw_pub/r/sfdw/owsrf_public/srf-map) |       💧💧💧💧💧       |    💧💧     | A live, filter-able table of every DWSRF agreement that has been signed or modified since 2021. See [site](https://www.epa.gov/dwsrf) and downloadable [report](https://sdwis.epa.gov/ords/sfdw_pub/r/sfdw/owsrf_public/combined-dw-cw-report-filters).
| EPA | [Data for Policy Analysis](https://www.epa.gov/sdwa/national-cost-analysis-drinking-water-regulations) |       💧💧💧💧       |    💧💧💧💧     | See [Baseline database](https://www.epa.gov/sdwa/data-economic-analysis-drinking-water-standards) for database that can be used for analysis. See [Cost Models](https://www.epa.gov/sdwa/drinking-water-treatment-technology-unit-cost-models) for cost modeling.
---
...
- **<u>Summary</u>**: Information can be combined with water quality data and mapped with GIS.
    - ECHO Drinking Water Data Downloads: https://echo.epa.gov/tools/data-downloads/sdwa-download-summary contains PWS address information that can be geocoded using GIS or https://www.epa.gov/rmp/determining-facilitys-latitude-and-longitude
    - FRS Geospatial Data Download Service: https://www.epa.gov/frs/geospatial-data-download-service
    ...
    - EnviroAtlas: https://enviroatlas.epa.gov/enviroatlas/interactivemap/ for interative map and https://www.epa.gov/enviroatlas/data-download?token=JZJqcTGD-0bDYuzvsukLXTOQssG9oYkWOnxAAH-Vy8c for data downloads.
    - US Census Bureau: https://data.census.gov/ for Census data updated every 10 years about the nation's people and the economy; use [tidycensus](https://walker-data.com/tidycensus/) to get data. See helper scipt file.
